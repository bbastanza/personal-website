...
const Portfolio = () => {
  ...
  const expenseData = {
    ...
    description:
      "Here is a simple expense tracker built in React JS. I started from scratch when building this app. I learned all about how React manipulates the virtual dom to display a web application. The syntax was very different from what I was used to and  that I am comfortable with it I see how powerful it can be.",
    image: expenseSS,
